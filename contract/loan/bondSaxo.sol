...
contract Token is ERC3475 {
    ...
    constructor() {
        ...
        _classes[0]._values["Name"].stringValue = "Saxo Bank";
        ...
        _classes[1]._values["symbol"].stringValue = "GLDMSACHSGRP-4.5-28SEP32";
        _classes[1]._values["category"].stringValue = "security";
        _classes[1]._values["subcategory"].stringValue = "bond";
        _classes[1]._values["childCategory"].stringValue = "corporate bond";
        
        _classes[1]._values["description"].stringValue = unicode"Goldman Sachs Group 4.25% 24 Apr 2033, EUR";
        _classes[1]._values["issuerName"].stringValue = "Goldman Sachs Group";
        _classes[1]._values["issuerType"].stringValue = "Inc";
        _classes[1]._values["issuerIndustry"].stringValue = "Financial Services";
        _classes[1]._values["issuerJurisdiction"].stringValue = "US";
        _classes[1]._values["issuerURL"].stringValue = "https://www.goldmansachs.com/";
        _classes[1]._values["issuerLogo"].stringValue = "https://upload.wikimedia.org/wikipedia/commons/6/61/Goldman_Sachs.svg";
        ...
        _classes[1]._values["currency"].stringValue = "EUR";  
        ...
        _classes[1]._values["couponPeriod"].uintValue = 366*60*60*24;  
        _classes[1]._values["fixed-rate"].boolValue = true;  
        _classes[1]._values["APY"].uintValue = 100000;  
        _classes[1]._values["subscribeLink"].stringValue = "https://www.saxotrader.com/d/page/product/Bond/31676788?activetab=profile";
