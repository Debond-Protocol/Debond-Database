...
contract Token is ERC3475 {
    ...
    struct Applicant{
        ...
        address applicantChainAddress;
        string applicantJurisdiction;
    }
    ...
    constructor(address _exchangeAddress ) {
        ...
        _classes[0]._values["warrantorName"].stringValue = "European Patent Office";
        _classes[0]._values["warrantorType"].stringValue = "Government Organization";

        _classes[0]._values["warrantorJurisdiction"].stringValue = "EU";
        _classes[0]._values["warrantorRegistrationAddress"].stringValue = unicode"Avenue de Cortenbergh 60 1000 Bruxelles";
        _classes[0]._values["warrantorURL"].stringValue = "https://www.epo.org/";
        _classes[0]._values["warrantorLogo"].stringValue = "https://github.com/Debond-Protocol/Debond-Database/blob/main/logo/EPO.jpeg";
        _classes[0]._values["warrantorIndustry"].stringArrayValue = ["European Patent Office"];
        _classes[0]._values["warrantorChainAddress"].stringValue = "0xE4A545225c9855f4D56f58747b361fF7C468a342";
       ...
       for (uint256 i = 0; i < inputData.length ; i++) {
            ...
            _classes[ classId]._values["applicantName"].stringValue = inputData[i].applicantData.applicantName;
            _classes[ classId]._values["applicantChainAddress"].addressValue = inputData[i].applicantData.applicantChainAddress;
            _classes[ classId]._values["applicantJurisdiction"].stringValue = inputData[i].applicantData.applicantJurisdiction;

    

            _classes[ classId]._values["warrantNumber"].stringValue = inputData[i].IPData.warrantNumber;
            _classes[ classId]._values["identificationNumber"].stringValue = inputData[i].IPData.identificationNumber;
            _classes[ classId]._values["IPC"].stringArrayValue = inputData[i].IPData.IPC;
            _classes[ classId]._values["CPC"].stringArrayValue = inputData[i].IPData.CPC;
            _classes[ classId]._values["authorName"].stringArrayValue = inputData[i].IPData.authorName;
            _classes[ classId]._values["authorChainAddress"].addressArrayValue = inputData[i].IPData.authorChainAddress;
            _classes[ classId]._values["domain"].stringValue = inputData[i].IPData.domain;
            _classes[ classId]._values["subdomain"].stringValue = inputData[i].IPData.subdomain;
            _classes[ classId]._values["keyWords"].stringArrayValue = inputData[i].IPData.keyWords;
            _classes[ classId]._values["cover"].stringArrayValue = inputData[i].IPData.cover;            
            _classes[ classId]._values["warrantorDocURL"].stringArrayValue = inputData[i].IPData.warrantorDocURL;
